...
void pre_auton(void) {
  ...
  backLift.setVelocity(150, pct);
  Arm.setVelocity(150, pct);
  Arm.setStopping(hold);
  claw.setVelocity(150, pct);
...
void usercontrol(void) {
  ...
  while (1) {
    ...
    if(!Controller2.ButtonR2.pressing() && !Controller2.ButtonR1.pressing()){
      backLift.stop();
    }
    if(!Controller2.ButtonX.pressing() && !Controller2.ButtonB.pressing()){
      claw.stop();
    }
    // ........................................................................

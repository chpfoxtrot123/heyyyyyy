...
void l(){
  ...
  wait(100, msec);
  intake.spinFor(reverse, 110, deg);//
  wait(100, msec);
  Drivetrain.driveFor(-7.0, inches, true);
...
void r(){
  ...
  Drivetrain.driveFor(7.0, inches, true);
  wait(100, msec);
  intake.spinFor(reverse, 120, deg);//
  wait(100, msec);
  Drivetrain.driveFor(-7.0, inches, true);
...
void Skills() {
  ...
  wait(100, msec);
  Drivetrain.setTimeout(5.0, sec);
  intake.spinFor(reverse, 5900, deg,false);//intakes disc 
